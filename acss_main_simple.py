...
SORT_DELAY = 1.4  # Seconds from detection to servo actuation (changed to 2s)
            ...
            try:
                ...
                if self.process_running and has_detection and current_time > self.detection_cooldown and as7263_valid:
                    ...
                    if candidates:
                        ...
                        self._log_message(f"Detected {category} for sorting (conf {conf:.2f}, moisture {moisture}%)")
